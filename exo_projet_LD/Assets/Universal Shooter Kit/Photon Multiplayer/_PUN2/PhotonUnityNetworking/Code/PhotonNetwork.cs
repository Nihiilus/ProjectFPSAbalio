...
namespace Photon.Pun
{
    ...
    public static partial class PhotonNetwork
    {
        ...
        /// 
        /// Internally, a Custom RoomManager Property is set for the loaded scene. On change, clients use LoadLevel
        ...
        /// but inside a RoomManager, all clients should have the same value (Rooms are on one server only).<br/>
        ...
        public static bool RaiseEvent(byte eventCode, object eventContent, RaiseEventOptions raiseEventOptions, SendOptions sendOptions)
        {
            ...
            {
                Debug.LogWarning("RaiseEvent(" + eventCode + ") failed. Your event is not being sent! Check if your are in a RoomManager and the eventCode must be less than 200 (0..199).");
                return false;
            }
        ...
        private static bool RaiseEventInternal(byte eventCode, object eventContent, RaiseEventOptions raiseEventOptions, SendOptions sendOptions)
        {
            ...
            if (!InRoom)
            {
                Debug.LogWarning("RaiseEvent(" + eventCode + ") failed. Your event is not being sent! Check if your are in a RoomManager");
                return false;
            }
        ...
        /// </summary>
        /// <remarks>
        /// Destroying a networked GameObject while in a RoomManager includes:
