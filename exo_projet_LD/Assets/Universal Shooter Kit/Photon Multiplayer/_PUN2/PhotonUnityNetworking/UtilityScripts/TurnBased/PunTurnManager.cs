...
namespace Photon.Pun.UtilityScripts
{
    ...
    /// Provides Extensions for Player, RoomManager and RoomInfo to feature dedicated api for TurnBased Needs
    /// </summary>
	public class PunTurnManager : MonoBehaviourPunCallbacks, IOnEventCallback
    {
        ...
        /// <summary>
        /// The turn manager event offset event message byte. Used internaly for defining data in RoomManager Custom Properties
        /// </summary>
        public const byte TurnManagerEventOffset = 0;

        /// <summary>
        /// The Move event message byte. Used internaly for saving data in RoomManager Custom Properties
        /// </summary>
        public const byte EvMove = 1 + TurnManagerEventOffset;

        /// <summary>
        /// The Final Move event message byte. Used internaly for saving data in RoomManager Custom Properties
        /// </summary>
    ...
    public static class TurnExtensions
    {
        ...
        /// Sets the turn.
        /// </summary>
        /// <param name="room">RoomManager reference</param>
        /// <param name="turn">Turn index</param>
        ...
        /// <param name="room">RoomManager.</param>
