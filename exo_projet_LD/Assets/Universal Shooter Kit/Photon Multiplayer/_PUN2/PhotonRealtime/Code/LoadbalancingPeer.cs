...
namespace Photon.Realtime
{
    ...
    public class LoadBalancingPeer : PhotonPeer
    {
        ...
        /// Game Server will return the joined RoomManager's data.
        /// This is an async request which triggers a OnOperationResponse() call.
        /// </summary>
        /// <remarks>
    ...
    public class GamePropertyKey
    {
        ...
        /// <summary>(245) RoomManager Time To Live. How long a room stays available (and in server-memory), after the last player becomes inactive. After this time, the room gets persisted or destroyed.</summary>
    ...
    /// <remarks>This directly maps to the fields in the RoomManager class.</remarks>
    ...
    {
        /// <summary>This lobby is used unless another is defined by game or JoinRandom. RoomManager-lists will be sent and JoinRandomRoom can filter by matching properties.</summary>
        Default = 0,
