...
namespace Photon.Realtime
{
    ...
    public class RoomInfo
    {
        ...
        /// <summary>Read-only "cache" of custom properties of a room. Set via RoomManager.SetCustomProperties (not available for RoomInfo class!).</summary>
        ...
        /// <summary>
        /// Count of players currently in room. This property is overwritten by the RoomManager class (used when you're in a RoomManager).
        /// </summary>
