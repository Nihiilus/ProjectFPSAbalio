// ----------------------------------------------------------------------------
// <copyright file="RoomManager.cs" company="Exit Games GmbH">
//   Loadbalancing Framework for Photon - Copyright (C) 2018 Exit Games GmbH
// </copyright>
// <summary>
//   The RoomManager class resembles the properties known about the room in which
...
namespace Photon.Realtime
{
    ...
    public class Room : RoomInfo
    {
        ...
        /// As part of a RoomManager (which the player joined), the setter will update the server and all clients.
        /// </remarks>
        ...
        /// <summary>The count of players in this RoomManager (using this.Players.Count).</summary>
        ...
        /// <summary>While inside a RoomManager, this is the list of players who are also in that room.</summary>
        ...
        /// <summary>RoomManager Time To Live. How long a room stays available (and in server-memory), after the last player becomes inactive. After this time, the room gets persisted or destroyed.</summary>
        ...
        /// <summary>
        /// The ID (actorNumber, actorNumber) of the player who's the master of this RoomManager.
        ...
        /// <summary>Creates a RoomManager (representation) with given name and properties and the "listing options" as provided by parameters.</summary>
        /// <param name="roomName">Name of the room (can be null until it's actually created on server).</param>
        /// <param name="options">RoomManager options.</param>
        ...
        /// <summary>
        /// Updates and synchronizes this RoomManager's Custom Properties. Optionally, expectedProperties can be provided as condition.
        /// </summary>
        /// <remarks>
        /// Custom Properties are a set of string keys and arbitrary values which is synchronized
        /// for the players in a RoomManager. They are available when the client enters the room, as
        /// they are in the response of OpJoin and OpCreate.
        ///
        /// Custom Properties either relate to the (current) RoomManager or a Player (in that RoomManager).
        ///
        ...
        /// Only useful when in a RoomManager, as IDs are only valid per RoomManager.
        /// </summary>
        ...
        /// <summary>Returns a summary of this RoomManager instance as string.</summary>
        /// <returns>Summary of this RoomManager instance.</returns>
        public override string ToString()
        {
            return string.Format("RoomManager: '{0}' {1},{2} {4}/{3} players.", this.name, this.isVisible ? "visible" : "hidden", this.isOpen ? "open" : "closed", this.maxPlayers, this.PlayerCount);
        }

        /// <summary>Returns a summary of this RoomManager instance as longer string, including Custom Properties.</summary>
        /// <returns>Summary of this RoomManager instance.</returns>
        public new string ToStringFull()
        {
            return string.Format("RoomManager: '{0}' {1},{2} {4}/{3} players.\ncustomProps: {5}", this.name, this.isVisible ? "visible" : "hidden", this.isOpen ? "open" : "closed", this.maxPlayers, this.PlayerCount, this.CustomProperties.ToStringFull());
        }
    }
}