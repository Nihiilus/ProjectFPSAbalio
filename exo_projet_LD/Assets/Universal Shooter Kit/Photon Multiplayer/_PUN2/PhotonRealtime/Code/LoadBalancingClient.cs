...
namespace Photon.Realtime
{
    ...
    public class LoadBalancingClient : IPhotonPeerListener
    {
        ...
        /// You need to define which Custom RoomManager Properties will be available for matchmaking when you create a room.
    ...
    public interface IMatchmakingCallbacks
    {
        ...
        /// </summary>
        /// <remarks>
        /// When this is called, you can access the existing players in RoomManager.Players, their custom properties and RoomManager.CustomProperties.
        ///
    ...
    public interface IInRoomCallbacks
    {
        ...
        /// RoomManager.playerCount and find out if you can start.
        /// </remarks>
        ...
        /// their spot in the room. In such cases, the Player stays in the RoomManager.Players dictionary.
        ///
        /// If the player is not just inactive, it gets removed from the RoomManager.Players dictionary, before
        ...
        /// <summary>
        /// Called when a room's custom properties changed. The propertiesThatChanged contains all that was set via RoomManager.SetCustomProperties.
        /// </summary>
        /// <remarks>
        /// Since v1.25 this method has one parameter: Hashtable propertiesThatChanged.<br/>
        /// Changing properties must be done by RoomManager.SetCustomProperties, which causes this callback locally, too.
        /// </remarks>
